//package com.acegroup.livelocationtracker.utils.authentication;
//
...
//                })
//                .positiveColor(context.getColor(R.color.colorPrimaryDark))
//                .negativeColor(context.getColor(R.color.colorPrimaryDark)).onPositive(new MaterialDialog.SingleButtonCallback() {
//                    @Override
//                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
//                        try {
